...
// After deploying Cloudflare Worker, replace the URL below with your Worker URL
// e.g., 'https://supabase-proxy.your-subdomain.workers.dev'
export const SUPABASE_URL = 'https://bsnyzpisrsywktjuzygf.supabase.co';
